...
def main() -> int:
    ...
    a_v4 = gate.parse_nft_set_elements_json(v4)  # type: ignore
    a_tcp_str = gate.parse_nft_set_elements_json(tcp_str)  # type: ignore
    a_tcp_int = gate.parse_nft_set_elements_json(tcp_int)  # type: ignore
    a_udp = gate.parse_nft_set_elements_json(udp)  # type: ignore

    _assert_eq("v4", sorted(a_v4), ["10.0.0.1", "10.0.0.2"])

    # The parser normalizes elements to strings.
